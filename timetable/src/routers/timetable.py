...
from src.rabbitMq.doctor import RabbitMQClient
from src.schemas.appointments import CreateAppointments
from src.schemas.timetable import TimetableCreate, TimetableResponse
from src.services.appointments import AppointmentsService
